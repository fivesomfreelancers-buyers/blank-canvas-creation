...
export const PHRASES: Record<string, Entry> = {
  ...
  'Explore Services': { so: 'Sahami Adeegyada', fr: 'Explorer les services', am: ' služሎቶችን ያስሱ', ar: 'استكشف الخدمات' },
  ...
  'Browse Services': { so: 'Fiiri Adeegyada', fr: 'Parcourir les services', am: ' služሎቶችን ይመልከቱ', ar: 'تصفح الخدمات' },
  'Featured Categories': { so: 'Qaybaha Muhiimka ah', fr: 'Catégories en vedette', am: 'ተመራጭ ምድቦች', ar: 'الفئات المميزة' },
  'Popular Services': { so: 'Adeegyada Caanka ah', fr: 'Services populaires', am: 'ታዋቂ služሎቶች', ar: 'الخدمات الشائعة' },
  ...
  'Search services...': { so: 'Raadi adeegyada...', fr: 'Rechercher des services...', am: 'služሎቶችን ፈልግ...', ar: 'ابحث عن خدمات...' },
