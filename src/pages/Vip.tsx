...
const TIERS = [
  ...
  },
  {
    ...
    popular: true,
    perks: [
      '✅ Allowed 3 Active VIP Gigs',
      'Platinum verified tick ✔️',
      'Homepage featured priority',
      'Highest ranking — above Golden',
      'Strong campaign boost',
      'Premium featured placement',
      'Priority support 24/7',
      'Trusted premium seller badge',
      'Platform-wide visibility boost',
      'More buyer trust & higher algorithm ranking',
    ],
